...
- 決定変数: 暗号化推論
- 主な効果: ループの**適用範囲**を拡張（秘匿データ領域を開放）

- 決定変数: 形式検証
- 主な効果: ループの**回転速度**を向上（人間検証ボトルネックを除去）
...
## 第1章 自動アルゴリズム発見（AlphaEvolve）——研究を"パイプライン"にする
...
## 第2章 自律研究（AI Scientist-v2）——仮説→実験→論文→投稿の閉ループ
...
## 第3章 TTS（Test-Time Scaling）——生成→選別→検証→合成の最適配分
...
## 第4章 GenCluster——オープン重み×探索設計でIOI金級へ

### 4.1 What changed——オープンモデルが競技プログラミングで金メダル水準に達した
...
## 第5章 MetaStone-S1——自己教師PRM/選別器統合で推論を安く強くする
...
## 第6章 DeepSeek-R1——低コスト推論の"供給ショック"が競争構造を変える
...
# Part III：潜在推論・記憶・継続学習

## 第7章 潜在推論（COCONUT）——CoTの外側で推論する
...
## 第8章 テスト時長期記憶（Titans / MIRAS）——推論しながら覚える
...
## 第9章 記憶システム（HippoRAG 2）——RAGから非パラメトリック継続学習へ
...
## 第11章 Genie 3——インタラクティブ環境生成が"訓練基盤"になる
...
## 第12章 V-JEPA 2——観察中心学習が計画・行動へ接続する
...
## 第13章 ヒューマノイド基盤（GR00T N1）——合成データ飛車で身体性をスケールさせる
...
## 第16章 医療の高頻度コストを潰す——アンビエント・スクライビング（NHS）
...
## 第17章 Stargate——成長律が電力と建設速度に支配される
...
## 第18章 EU AI Factories / UK Compute Roadmap——計算アクセスが産業政策になる
...
## 第19章 Sovereign AI（台湾）——ハード供給国→AI運用国への転位
...
## 第20章 EUV国産化（中国）——最先端AIの上限は"製造装置"で決まる
...
## 第21章 供給網のボトルネック——HBM/先端パッケージ/光I/O
...
## 第22章 議決権つきAI取締役（SKAI）——統治構造の一部になる
...
## 第23章 AI閣僚（Diella）——公共調達＝国家の血流にAIを直結する
...
## 第24章 ボードルームAI（Aiden）——非議決でも"前提"を支配する
...
# Part VIII：暗号化推論・監査 (Confidential AI)

## 第25章 非対話型・暗号化推論（NEXUS等）——秘密のまま推論する
...
## 第26章 監査・改竄耐性・責任主体——最上位意思決定で必須になる設計
...
- タイトル: AlphaEvolve on Google Cloud
- URL: https://cloud.google.com/blog/products/ai-machine-learning/alphaevolve-on-google-cloud
- 種別: 公式
- 確認日: 2025-06

- タイトル: AI Scientist初採択発表
- URL: https://sakana.ai/ai-scientist-first-publication/
- 種別: 公式
- 確認日: 2025-01

- タイトル: AI Scientist日本語版
- URL: https://sakana.ai/ai-scientist-first-publication-jp/
- 種別: 公式
- 確認日: 2025-01

- タイトル: AI Scientist実験コード
- URL: https://github.com/SakanaAI/AI-Scientist-ICLR2025-Workshop-Experiment
- 種別: GitHub
- 確認日: 2025-01

#### 推論＝探索工学（TTS）・オープン推論

- タイトル: DeepSeek-R1リポジトリ
- URL: https://github.com/deepseek-ai/DeepSeek-R1
- 種別: GitHub
